...
cat "${script_dir}/prompt-1.md" | esed "s/{LECTURE}/${lecture}/" | eclip set
# wait for user input before proceeding
read -rp "Paste clipboard contents into LLM prompt, then press Enter to continue..."
# copy second part of prompt template to clipboard
cat "${script_dir}/prompt-2.md" | esed "s/{LECTURE}/${lecture}/" | eclip set
